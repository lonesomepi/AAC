...
?>
      <div id="content">
        ...
        <div class="freeGraphs">
          ...
          <p><b>or</b></p>
          <p>If you wish to print the form, please download it: <a href="<?php echo $root; ?>docs/<?php echo $application; ?>.pdf" target="_blank"><b>here</b></a></p>
        </div><!-- header graphs -->
        ...
        <section>
          ...
          <section>
            ...
            <p>Organization:*</p>
            <input type="text" name="volunteer_experience_one_organization" value="" required>
            <p>Contact Person:</p>
            ...
            <textarea name="volunteer_experience_one_duties" rows="8" required placeholder="If none, please explain here"></textarea>
